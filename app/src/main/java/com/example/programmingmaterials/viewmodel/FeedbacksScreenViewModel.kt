...
@HiltViewModel
class FeedbacksScreenViewModel @Inject constructor(private val feedbackRepo: FeedbackRepo) :
    ViewModel() {
    ...
    init {
        viewModelScope.launch {
            val userFeedbacks = feedbackRepo.getUserFeedbacks(1)
    ...
    fun onClickDeleteButton(feedbackId: Int) {
        viewModelScope.launch {
            ...
            val updatedFeedbacks = feedbackRepo.getUserFeedbacks(1)
